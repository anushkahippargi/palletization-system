...
private:
    ...
    int calculateBoxesAlong(double palletDimension, double boxDimension) const;

    Candidate evaluateCandidate(const Pallet& pallet,
                                const Orientation& orientation,
                                int boxesAlongLength,
                                int boxesAlongWidth) const;

    void addPlacement(PalletizationResult& result,
                      int boxId,
                      int palletId,
                      double x,
                      double y,
